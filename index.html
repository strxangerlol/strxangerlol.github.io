...
<img class="giphy" src="bg.gif">

<div class ="content d-flex align-items-center">

  <div id= "center" class ="container text-center">
    
    <h1 style="color:white; padding-bottom: 6px"> NightfallGT </h1> 

    <span class="icons">
        <span id="block">
            <a style="color: Tomato;" href="https://discord.gg/g3QR4yemWW"><i class="fab fa-discord fa-2x" ></i></a>
        </span>
        <span id="block">
            <a style="color: Tomato;" href="https://www.youtube.com/channel/UCeS4wXCTumJQ4SerN8QSenQ?view_as=subscriber"><i class="fab fa-youtube fa-2x"></i></a>
        </span>
        <span id="block">
            <a style="color: Tomato;" href="https://github.com/nightfallgt"><i class="fab fa-github fa-2x"></i></a>
        </span>
  ...
  <div>
       ...
       <label class="switch">
        ...
        <audio id="myaudio"> <source src="music.mp3" type="audio/mp3"> </audio>
        </label>
